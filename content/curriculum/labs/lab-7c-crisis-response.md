...
What do you do RIGHT NOW about the chatbot?
...
**Decision 2: Internal Notification**
Who do you notify first and what do you tell them?
...
**Decision 3: External Response**
What do you do about the Twitter post?
- Ignore it for now
- Reply publicly
- DM the customer
- Have PR handle it
...
**Decision 4: CEO Briefing**
Write the key points for your 5-minute CEO briefing:
...
**Decision 5: Customer Communication**
Draft the email that will go to the 127 affected customers:
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
URGENT: Board Meeting in 24 Hours
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Context: 3 months ago, you championed an AI pilot for automated
...
**Decision 1: Response to VP**
You have to call the VP back in 10 minutes. What do you say?
...
**Decision 2: Board Presentation**
You cannot hide the results—that would be career-ending. How do you frame this?

Option A: Lead with the failure, explain learnings
Option B: Lead with learnings, explain results in context
Option C: Request to postpone presentation for more analysis
Option D: Present results as "Phase 1" with Phase 2 plan

Your choice: ________________________________

Rationale: ________________________________

**Decision 3: Accountability & Path Forward**
...
Original Scope (approved 6 months ago):
...
**Decision 1: Immediate Response to CIO**
Draft your response to the CIO:
...
**Decision 2: Options Analysis**
Complete this options table:
...
**Decision 3: CCO Meeting Prep**
You'll meet with the CCO in 2 hours. Prepare:
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
CONFIDENTIAL: Bias Discovery
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Context: Your team deployed an AI-powered loan pre-screening tool
...
**Decision 1: Immediate Response to VP**
...
**Decision 2: Immediate vs. Thorough**
You face a classic crisis trade-off:
...
**Decision 3: Stakeholder Notification**
...
**Decision 4: Affected Applicants**
What do you do about the 2,000-3,000 potentially affected?
...
**Decision 5: Public Disclosure**
Draft the key messages for public communication:
...
**Decision 6: Lessons Learned**
What governance should have prevented this?
...
**Immediate Shutdown vs. Investigate:**
Consider shutting down immediately if:
- ________________________________
- ________________________________
